...
//////////Chao: Add 80 patterns from Thesis of Aja Huang////////////
#if 0
	#define PAT3_N 15
#else
	#define PAT3_N 95
...
static char moggy_patterns_src[PAT3_N][11] = {
	...
	"###",
#endif
///////Pattern are listed in Aja_Phd_Thesis.pdf, P79, by Aja Huang./////////////////
///////Chao: All patterns make sense to me. Though there are dupes below.///////////
///////The dupes are marked :)//////////////////////////////////////////////////////
#if 1
	/*1*/
	"???"
	"?.X"
